...
import BlastRequest from './Screens/BlastRequest';
import BlastRequest2 from './Screens/BlastRequest2';
...
const App = () => {
  ...
  return (
    <NavigationContainer style={styles.MainScreenStyle}>
      <Stack.Navigator
        initialRouteName="BlastRequest2"
        ...
        <Stack.Screen name="BlastRequest" component={BlastRequest} />
        <Stack.Screen name="BlastRequest2" component={BlastRequest2} />
      </Stack.Navigator>
    </NavigationContainer>
